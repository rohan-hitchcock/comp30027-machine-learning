...
def plot_pca_components(datasets_dict, low_rating, med_rating, high_rating, n=3):
...
def plot_pca_components_vs_variance(datasets_dict):
...
if __name__ == "__main__":
    ...
    #plot_pca_components_vs_variance(datasets_dict)
